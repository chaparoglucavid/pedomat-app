...
Route::middleware('auth')->group(function () {
    ...
    // balance operations
    Route::get('balance', [UserBalanceController::class, 'index'])->name('user-balance');
    Route::get('balance-history', [UserBalanceController::class, 'userBalanceHistory'])->name('user-balance-history');
